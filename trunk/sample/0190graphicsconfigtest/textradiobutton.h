#ifndef sample_0190graphicsconfigtest_textradiobutton_h
#define sample_0190graphicsconfigtest_textradiobutton_h
...
class TextRadioButton : public Maid::IGUIRadioButton
{
public:
