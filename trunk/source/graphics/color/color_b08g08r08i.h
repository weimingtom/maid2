#ifndef maid2_graphics_color_color_b08g08r08i_h
#define maid2_graphics_color_color_b08g08r08i_h
...
{
	/*!
	 	@class	COLOR_B08G08R08I color_b08g08r08i.h
	 	@brief	アルファ無２４ビットピクセル
	 */
	class COLOR_B08G08R08I
	{
	public:
		COLOR_B08G08R08I(){}	//!<	コンストラクタ
		COLOR_B08G08R08I( unt16 b, unt16 g, unt16 r ) { SetRGB(r,g,b); }	//!<	コンストラクタ

    template <class COLOR>
		COLOR_B08G08R08I( const COLOR& Col ){  SetRGB( Col.GetR(), Col.GetG(), Col.GetB() );  }	//!<	コンストラクタ
		...
		operator unt32()const{ return (m_Blue<<16)|(m_Green<<8)|(m_Red<<0); }	//!<	一括変換
		...
		COLOR_B08G08R08I& operator = (const PIXEL &src)
		{
			SetRGB(src.GetR(),src.GetG(),src.GetB());
			return *this;
		}
		//!	同じピクセルフォーマットとのコピー
		COLOR_B08G08R08I& operator = (const COLOR_B08G08R08I& src)
		{
			m_Blue = src.m_Blue;
			m_Green = src.m_Green;
			m_Red = src.m_Red;
