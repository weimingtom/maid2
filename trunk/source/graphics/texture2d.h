...
namespace Maid
{
  namespace KEEPOUT
  {
    ...
    private:
      FUCTIONRESULT LoadImage( const String& filename, std::vector<SurfaceInstance>& dst );
      FUCTIONRESULT ConvertSubResource( const std::vector<SurfaceInstance>& src, std::vector<SurfaceInstance>& dst );
